...
#'
#' Given the final output/statistical tables from different chromatographic/polarity analyses of the same study (e.g.: HILIC POS, RPLC NEG), it combines together the results.
#'
#' @param results_list a list, each element should be a data frame with a list of results (e.g. from the statistical analyses) we would combine together. Ideally, each row should be an annotated compound, each column can contain any information about it, for example results of statistics, chemical information, feature intensities, etc..
