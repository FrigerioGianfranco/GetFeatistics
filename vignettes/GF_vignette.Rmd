...
```{r, eval=FALSE}
export_the_table(EXAMPLE_DESCRIPTIVE_STATISTICS_RESULTS, exprtname = "The_results_of_statistics", exprt_type = "csv")
``` 
...
```{r, eval=FALSE}
export_figures(EXAMPLE_BOX_PLOTS, exprtname_figures = "Amazing_boxplots", exprt_fig_type = "pdf")
```
