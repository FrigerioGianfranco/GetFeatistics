...
performs 2-way ANOVA, with also TukeyHSD posthoc tests for between
...
``` r
gentab_P.2wayANOVA_posthocTukeyHSD(
  DF,
  v,
  f,
  interact = FALSE,
...
- f:
  ...
  character vector of length 2. Name of the two columns of df containing
  the factor variables for performing the two-way ANOVA.

- interact:

  logical. Do you also want to perform interactions?
